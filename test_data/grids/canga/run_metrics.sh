...
#python $METRICS_FOLDER/CANGAMetricsDriver.py --ss $METRICS_FOLDER/ICOD/sample_NM16_O10_ICOD-r32_TPW_CFR_TPO_A1_A2.nc --st $METRICS_FOLDER/ICOD/sample_NM16_O10_ICOD-r16_TPW_CFR_TPO_A1_A2.nc --smc 1 --tmc 1 --field $FIELDNAME  --data $DATA_FOLDER/ICOD_32.g-ICOD_16.g --dimension 1 --output $METRICS_FOLDER/out_0.csv > $METRICS_FOLDER/out.txt
#python $METRICS_FOLDER/CANGAMetricsDriver.py --ss $METRICS_FOLDER/ICOD/sample_NM16_O10_ICOD-r64_TPW_CFR_TPO_A1_A2.nc --st $METRICS_FOLDER/ICOD/sample_NM16_O10_ICOD-r32_TPW_CFR_TPO_A1_A2.nc --smc 1 --tmc 1 --field $FIELDNAME  --data $DATA_FOLDER/ICOD_64.g-ICOD_32.g --dimension 1 --output $METRICS_FOLDER/out_1.csv >> $METRICS_FOLDER/out.txt
#python $METRICS_FOLDER/CANGAMetricsDriver.py --ss $METRICS_FOLDER/ICOD/sample_NM16_O10_ICOD-r128_TPW_CFR_TPO_A1_A2.nc --st $METRICS_FOLDER/ICOD/sample_NM16_O10_ICOD-r64_TPW_CFR_TPO_A1_A2.nc --smc 1 --tmc 1 --field $FIELDNAME  --data $DATA_FOLDER/ICOD_128.g-ICOD_64.g --dimension 1 --output $METRICS_FOLDER/out_2.csv >> $METRICS_FOLDER/out.txt
#python $METRICS_FOLDER/CANGAMetricsDriver.py --ss $METRICS_FOLDER/ICOD/sample_NM16_O10_ICOD-r256_TPW_CFR_TPO_A1_A2.nc --st $METRICS_FOLDER/ICOD/sample_NM16_O10_ICOD-r128_TPW_CFR_TPO_A1_A2.nc --smc 1 --tmc 1 --field $FIELDNAME  --data $DATA_FOLDER/ICOD_256.g-ICOD_128.g --dimension 1 --output $METRICS_FOLDER/out_3.csv >> $METRICS_FOLDER/out.txt

# append to one file
NAMES=""
for i in {0..3}; do NAMES="$NAMES $METRICS_FOLDER/out_${i}_${FIELDNAME}.csv"; done;
echo $NAMES
